...
test('AI difficulty profiles keep easy variability and deterministic hard selection', () => {
...
test('hard AI always selects the highest-ranked strategic move', () => {
  const moves = [candidate('best', 100), candidate('second', 99), candidate('low', 79)];
