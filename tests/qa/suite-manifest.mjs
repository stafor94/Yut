...
const timingSafariVisibleSpec = 'tests/mobile/roll-timing-safari-visible-snapshot.spec.js';
...
const timingSafariVisibleSnapshotTitle = 'Safari에서 rAF로 관찰한 Good pointerdown snapshot은 180ms 뒤에도 화면·hold·제출·최종 판정이 Good으로 일치한다';
...
export const qaSuiteManifest = Object.freeze({
  ...
  'safari-visible-mismatch': Object.freeze({
    ...
    browserIsolationTest: 'tests/smoke/firebase-emulator-isolation.spec.js',
    grep: `${firebaseIsolationTitle}|${timingSafariVisibleSnapshotTitle}|${timingOverflowTitle}`,
    sharedTargets: Object.freeze([timingSafariVisibleSpec, timingOverflowSpec]),
    tests: Object.freeze([timingSafariVisibleSpec, timingOverflowSpec]),
  }),
