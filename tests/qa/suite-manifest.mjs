...
const onlineMovePriorTurnStartSpec = 'tests/mobile/online-move-prior-turn-start.spec.js';
...
export const qaSuiteManifest = Object.freeze({
  ...
  'mobile-galaxy-move-start': Object.freeze({
    ...
    sharedTargets: Object.freeze([onlineMoveSingleExecutionSpec, onlineMovePriorTurnStartSpec]),
    tests: Object.freeze([onlineMoveSingleExecutionSpec, onlineMovePriorTurnStartSpec]),
  }),
