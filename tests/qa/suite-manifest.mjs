...
export const qaSuiteManifest = Object.freeze({
  ...
  'mobile-galaxy-move-start': Object.freeze({
    ...
    sharedTargets: Object.freeze([onlineMoveSingleExecutionSpec, onlineMoveFastStartSpec]),
    tests: Object.freeze([onlineMoveSingleExecutionSpec, onlineMoveFastStartSpec]),
  }),
