...
if (failures.length === 0) {
  ...
  await record('QA cleanup and layout regression', 'npm', ['run', 'test:qa-cleanup-layout-regression', '--', '--output=test-results/cleanup-layout'], 'playwright-qa-cleanup-layout-regression.log');
}
