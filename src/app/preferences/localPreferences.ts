...
export const readStoredText = (storage: PreferenceStorage | null, key: string, fallback: string) =>
  storage?.getItem(key) || fallback;

export const readStoredBoolean = (storage: PreferenceStorage | null, key: string, fallback: boolean) => {
...
export const getStoredPlayMode = () =>
  getStoredText(STORAGE_KEYS.playMode, 'individual') === 'team' ? 'team' as const : 'individual' as const;
