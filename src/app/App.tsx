...
export function App() {
  ...
  const boardTurnIndicatorText = winner ? renderWinnerText(true) : visibleBoardTurnSeat ? `${visibleBoardTurnSeat.label}-${visibleBoardTurnSeat.name} 턴` : '';
