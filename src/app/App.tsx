...
export function App() {
  ...
  useEffect(() => {
    ...
    return () => window.clearTimeout(timer);
  }, [activeSeat?.id, activeSeat?.label, activeSeat?.name, activeTurnOrderIntro, screen, turnIndex, winner]);
